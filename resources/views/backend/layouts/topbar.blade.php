        ...
        <div class="d-flex">
            ...
            <div class="navbar-brand-box">
                <a href="index" class="logo logo-dark">
                    ...
                    <span class="logo-lg">
                        <img src="{{ asset('assets/backend/images/logo.png') }}" class="img-thumbnail" alt="" height="17">
                    </span>
                </a>
                ...
                <a href="{{ route('backend.home') }}" class="logo logo-light">
                    ...
                    <span class="logo-lg">
                        <img src="{{ asset('assets/backend/images/logo.png') }}" class="img-thumbnail" alt="" height="19">
                    </span>
                </a>
            </div>
